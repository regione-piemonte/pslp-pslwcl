...
@Component({
    selector: 'pslfcwcl-app-collocamento-landing',
    templateUrl: './app-collocamento-landing.component.html'
  })
  export class AppCollocamentoLandingComponent implements OnInit {
    ...
    controllaUtente() {
      ...
      this.utilitiesService.setLinkLand('/collocamento-mirato');
