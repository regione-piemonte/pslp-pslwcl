...
import {
  ConfigService, SpidUserService, UtilitiesService
...
@Component({
    selector: 'app-gg-landing',
    templateUrl: './app-gg-landing.component.html'
  })
  export class AppGgLandingComponent implements OnInit {
    ...
    controllaUtente() {
      ...
      this.utilitiesService.setLinkLand('/garanzia-giovani');
