...
@Component({
    selector: 'app-rdc-landing',
    templateUrl: './app-rdc-landing.component.html'
  })
  export class AppRdcLandingComponent implements OnInit {
     ...
     */
    controllaUtente() {
      this.logService.log("RDC landing---------------->" + location.href);
      // Non ho l'utente e sono in sviluppo/test, allora pagina di login
      this.utilitiesService.setLinkLand('/reddito-cittadinanza');
